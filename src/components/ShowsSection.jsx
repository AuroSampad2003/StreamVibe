    ...
    return (
        <div className="text-white px-20 xl-max:px-10 sm-max:px-3 mt-16 mb-16">
            <div className="border border-black5 rounded-2xl px-2">
                <h2 className="inline font-bold text-xl md-max:text-lg mb-2 relative bottom-4 left-9 rounded-lg px-3 py-2 bg-red1">Shows</h2>

                <div className="movies-sections mt-6 space-y-8">
                    {/* Our Genres */}
