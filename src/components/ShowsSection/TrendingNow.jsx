      ...
      >
        {data.map((item, index) => (
          <div
            ...
            className='bg-[#1A1A1A] border border-[#262626] rounded-2xl mx-2 p-4 hover:scale-105 hover:shadow-lg transition-transform duration-300 ease-in-out cursor-pointer'
          >
            <img 
